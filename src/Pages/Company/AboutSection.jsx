...
export default function AboutSection() {
  return (
    <div className="w-full">
      {/* Main About Section */}
      <section className="bg-white py-16  md:px-12 lg:px-20">
        <div className="max-w-7xl px-6 mx-auto">

          {/* DeshITBD & Simplifying Text */}
          <div className="w-full space-y-6">
            <div>
              <h1 className="text-3xl md:text-4xl lg:text-[60px] font-bold text-[#1a365d] mb-4">DeshITBD</h1>
              <p
      ...
      <section className="px-6 md:px-12 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-[1051px] space-y-6">
            <h2 className="text-center text-3xl md:text-[70px] font-bold text-[#1a365d]">Mission</h2>

          </div>
          <div className="flex flex-col lg:flex-row items-start justify-between gap-8 mt-10">

            {/* Mission Text - Fixed Width on Large Screens */}
            <p className=" text-xl lg:text-2xl text-gray-600 leading-relaxed  w-full md:w-auto lg:w-[1051px]">
      ...
      <section
        ...
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-8">How we work</h2>
